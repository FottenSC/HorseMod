...
std::atomic<std::uint64_t>
    DeterministicHookSet::movevm_execute_bank_slot_trampoline_global_{};
std::atomic<std::uint64_t>
    DeterministicHookSet::movevm_write_chara_state_short_trampoline_global_{};
std::atomic<std::uint64_t>
...
namespace
{
struct TiraStanceHelperContext
{
    void* owner{};
...
thread_local TiraStanceHelperContext tira_stance_helper{};
