...
UEngine::UEngine() {
    ...
    this->PlayOnConsoleSaveDir = TEXT("Autosaves");
    ...
    this->bHardwareSurveyEnabled = true;
    ...
    this->SelectionMeshSectionHighlightIntensity = 0.00f;
    this->BSPSelectionHighlightIntensity = 0.00f;
    this->HoverHighlightIntensity = 10.00f;
