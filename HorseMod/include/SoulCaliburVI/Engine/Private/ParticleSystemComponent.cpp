...
UParticleSystemComponent::UParticleSystemComponent(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {
    ...
    this->AutoAttachLocationType = EAttachLocation::KeepRelativeOffset;
...
void UParticleSystemComponent::SetVectorParameter(FName ParameterName, FVector Param) {
}
...
void UParticleSystemComponent::SetColorParameter(FName ParameterName, FLinearColor Param) {
}
...
void UParticleSystemComponent::SetActorParameter(FName ParameterName, AActor* Param) {
}
