...
public:
    ...
    UFUNCTION(BlueprintCallable)
    static void SetAssetPropertyByName(UObject* Object, FName PropertyName, const UObject*& Value);
    
    UFUNCTION(BlueprintCallable)
    static void SetAssetClassPropertyByName(UObject* Object, FName PropertyName, const UClass*& Value);
    ...
    UFUNCTION(BlueprintCallable, meta=(WorldContext="WorldContextObject"))
    static void QuitGame(UObject* WorldContextObject, APlayerController* SpecificPlayer, TEnumAsByte<EQuitPreference::Type> QuitPreference);
    ...
    static bool NotEqual_SoftObjectReference(const UObject*& A, const UObject*& B);
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    static bool NotEqual_SoftClassReference(const UClass*& A, const UClass*& B);
    ...
    UFUNCTION(BlueprintCallable, meta=(Latent, LatentInfo="LatentInfo", WorldContext="WorldContextObject"))
    static void LoadAssetClass(UObject* WorldContextObject, UClass* AssetClass, UKismetSystemLibrary::FOnAssetClassLoaded OnLoaded, FLatentActionInfo LatentInfo);
    
    UFUNCTION(BlueprintCallable, meta=(Latent, LatentInfo="LatentInfo", WorldContext="WorldContextObject"))
    static void LoadAsset(UObject* WorldContextObject, UObject* Asset, UKismetSystemLibrary::FOnAssetLoaded OnLoaded, FLatentActionInfo LatentInfo);
    ...
    UFUNCTION(BlueprintCallable)
    static FTimerHandle K2_SetTimerDelegate(FTimerDynamicDelegate Delegate, float Time, bool bLooping);
    ...
    UFUNCTION(BlueprintCallable, BlueprintPure)
    static bool IsValidSoftObjectReference(const UObject*& SoftObjectReference);
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    static bool IsValidSoftClassReference(const UClass*& SoftClassReference);
    ...
    UFUNCTION(BlueprintCallable, BlueprintPure)
    static UObject* GetSoftObjectReferenceFromPrimaryAssetId(FPrimaryAssetId PrimaryAssetId);
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    static UClass* GetSoftClassReferenceFromPrimaryAssetId(FPrimaryAssetId PrimaryAssetId);
    ...
    UFUNCTION(BlueprintCallable, BlueprintPure)
    static FPrimaryAssetId GetPrimaryAssetIdFromSoftObjectReference(UObject* SoftObjectReference);
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    static FPrimaryAssetId GetPrimaryAssetIdFromSoftClassReference(UClass* SoftClassReference);
    ...
    UFUNCTION(BlueprintCallable, BlueprintPure)
    static bool EqualEqual_SoftObjectReference(const UObject*& A, const UObject*& B);
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    static bool EqualEqual_SoftClassReference(const UClass*& A, const UClass*& B);
    ...
    UFUNCTION(BlueprintCallable, BlueprintPure)
    static UObject* Conv_SoftObjectReferenceToObject(const UObject*& Asset);
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    static UClass* Conv_SoftClassReferenceToClass(const UClass*& AssetClass);
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    static UObject* Conv_ObjectToSoftObjectReference(UObject* Object);
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    static UObject* Conv_InterfaceToObject(const FScriptInterface& Interface);
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    static UClass* Conv_ClassToSoftClassReference(const UClass*& Class);
