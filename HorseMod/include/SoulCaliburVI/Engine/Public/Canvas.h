...
public:
    ...
    UFUNCTION(BlueprintCallable)
    void K2_DrawText(UFont* RenderFont, const FString& RenderText, FVector2D ScreenPosition, FLinearColor RenderColor, float Kerning, FLinearColor ShadowColor, FVector2D ShadowOffset, bool bCentreX, bool bCentreY, bool bOutlined, FLinearColor OutlineColor);
    ...
    UFUNCTION(BlueprintCallable)
    void K2_DrawBox(FVector2D ScreenPosition, FVector2D ScreenSize, float Thickness);
